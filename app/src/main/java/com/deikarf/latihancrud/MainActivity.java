...
private void callVolley(int page){
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_login) {
            Intent intent = new Intent(this, com.deikarf.latihancrud.Login2Activity.class);
            this.startActivity(intent);
            return true;

        } else if (id == R.id.nav_register) {

            Intent intent = new Intent(this, com.deikarf.latihancrud.RegisterActivity.class);
            this.startActivity(intent);
            return true;
